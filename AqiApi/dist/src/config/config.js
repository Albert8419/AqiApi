...
const mnemonic = "session recall clarify journey fashion rural steel clay brick yard winner major chuckle hospital soldier file tumble monster jeans ball differ person butter able setup";
